...
then
	...
	do
		cd $dir_new_videos
		ffmpeg -i $n -vcodec libx264 -acodec aac -strict experimental -vpre libx264-ipod640 $dir_converted_videos/$n-$stamp.mp4
		ffmpeg -i $n -acodec libvorbis -s 640x360 $dir_converted_videos/$n-$stamp.webm
