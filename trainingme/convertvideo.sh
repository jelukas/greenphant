...
then
	...
	do
		cd $dir_new_videos
		ffmpeg -i $n -vcodec libx264 -acodec aac -strict experimental -vpre ipod640 $dir_converted_videos/$n-$stamp.mp4
		ffmpeg -i $n -acodec libvorbis -ac 2 -ab 96k -ar 44100 -b 345k -s 640x360 $dir_converted_videos/$n-$stamp.webm
